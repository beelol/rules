...
1. **One-line verdict.** The overall result in one sentence. For example, "Product code is low risk; the problems are in what the new local modes do."
...
```markdown
**N. <What goes wrong, stated plainly>**
...
- Read-only. Do not edit code, commit, push, or post comments under this skill.
- To post labeled findings on GitHub, hand off to review-pr. To act on existing feedback, use address-pr-review.
